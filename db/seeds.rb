...
Expense.create(category: "Misc", budget: 50, user_id: 1, misc: true, month: "January")
Expense.create(category: "Coffee", budget: 50, user_id: 1, month: "January")
Expense.create(category: "Food", budget: 50, user_id: 1, month: "February")
Expense.create(category: "Bills", budget: 50, user_id: 1, month: "February")
